...
/**
 * IngredientRepository for working with the DB through the JpaRepository. Used
 * baseline code from RecipeRepository, changed relevant field and method names
 *
